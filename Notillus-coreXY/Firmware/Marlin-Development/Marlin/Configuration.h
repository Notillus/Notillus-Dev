...
#define CUSTOM_MENDEL_NAME "Notillus 0.9"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {84.38,84.38,4020,85}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 4, 60}    // (mm/sec)
