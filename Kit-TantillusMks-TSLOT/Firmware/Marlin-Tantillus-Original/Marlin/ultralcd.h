...
#include "Marlin.h"
  ...
  enum MainStatus{Main_Status, Main_Menu, Main_Prepare1, Main_Prepare2, Sub_PrepareMove, Sub_PrepareLoad, Sub_PrepareUnload, Main_Control, Main_SD,Sub_TempControl,Sub_MotionControl};
